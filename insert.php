...
<head>
	<meta charset="UTF-8">
	<title>Nuevo usuario Quaxar</title>
	...
	<div class="accion">
		...
		<form action="" method="post">
			...
			<div class="form-group">
				...
				<input type="text" name="ciudad" placeholder="Ciudad Origen" class="input__text">
			</div>
			<div class="form-group">
				<input type="text" name="correo" placeholder="Correo empresarial" class="input__text">
			</div>
